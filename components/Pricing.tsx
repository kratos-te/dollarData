...
import { getPriceId, postData } from '@/utils/helpers';
...
export default function Pricing({
  ...
  const handleGetId = async () => {
    ...
    if (!userId) return;
    const apikey = userId.toString();
    const priceId = await getPriceId(apikey);
  };
    ...
    <section className="bg-black">
      <div className="max-w-6xl px-4 py-8 mx-auto sm:py-24 sm:px-6 lg:px-8">
        <div className="sm:flex sm:flex-col sm:align-center">
          ...
          <button onClick={handleGetId} className="text-white font-semibold">
            GetId
          </button>
